...
def get_density(point_of_interest: tuple[float, float, float], list_of_coordinates: list[tuple[float, float, float]], threshold: float) -> int:  #tuple[int, dict[tuple[float,float,float], int]]:
    distances = {}
